...
public class updateThread2 {
	...
	public updateThread2(int seconds) {    //in constructor make list of files in input folder
    	...
    	public void run() {
    		try{
                ...
                if(flag==1)                 // if any changes done in folder then send update request to server
                {
                	...
                	try
                	{
                        Socket socket = new Socket(Client2.ServerIpAddress,Client2.ServerPort);
