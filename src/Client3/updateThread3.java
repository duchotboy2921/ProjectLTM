...
public class updateThread3 {
	...
	public updateThread3(int seconds) {    //in constructor make list of files in input folder
    	...
    	public void run() {
    		try{
                ...
                if(flag==1)                 // if any changes done in folder then send update request to server
                {
                	...
                	try
                	{
                        Socket socket = new Socket(Client3.ServerIpAddress,Client3.ServerPort);
